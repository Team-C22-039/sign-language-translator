        ...
        <nav className="bg-light-color border-gray-200 px-2 sm:px-4 py-3.5 dark:bg-dark-color">
            <div
                ...
                <button
                    ...
                    type="button"
                    className="inline-flex items-center p-2 ml-3 text-sm text-white rounded-lg md:hidden hover:bg-dark-color focus:outline-none focus:ring-2 focus:ring-white dark:text-white dark:hover:bg-light-color dark:focus:ring-white"
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul
                        className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                        <li>
                            <a
                                href="#"
